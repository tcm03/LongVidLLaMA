...
PATH_TO_JSON_TRAIN="/content/drive/MyDrive/Thesis/EnTube_preprocessing/data/EnTube_20m_train.json"
PATH_TO_JSON_VAL="/content/drive/MyDrive/Thesis/EnTube_preprocessing/data/EnTube_20m_test.json"
